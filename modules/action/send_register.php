...
if(isset($_POST['send_register'])) {
	...
	$txtAge = $_POST['age'];
	$txtParentName = $_POST['parent_name'];
	$txtEmail = $_POST['email'];
	$txtTel = $_POST['tel'];
	$txtAddress = $_POST['address'];
	$txtCourse = isset($_POST['course']) ? implode('; ', $_POST['course']) : '';
