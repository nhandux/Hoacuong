...
<div class="wrap-detail clearfix">
	...
	<div id="horizontalTab" class="r-tabs-smoke">
		<ul class="clearfix">
			...
			<li><a href="#tab-4" class="order"><?php echo $lgTxt_tab_bookingHotel;?></a></li>
		</ul>
		...
		<div id="tab-4">
			<div class="form-booking f-space10">
				...
				<form id="_frm_booking" name="frm_booking" class="frm" method="post" onsubmit="return sendMail('send_hotel', '_frm_booking');">
					<input type="hidden" name="id" value="<?php echo stripslashes($row['article_id']); ?>">
					...
					<div class="f-booking-itm">
						<div class="f-itm-txt"><span><?php echo $lgTxt_booking_hotel_date_begin;?><sup class="red">(*)</sup></span></div>
						<div class="f-itm-0">
							<div class="f-itm-1">
								<div class="form-item">
									<input type="text" class="date-begin" name="hotel_date_begin" value="" maxlength="250">
									<i class="fa fa-calendar"></i>
								</div>
							</div>
							<div class="f-itm-2">
								<div class="f-itm-txt"><span><?php echo $lgTxt_booking_hotel_date_end;?><sup>&nbsp;</sup></span></div>
								<div class="f-itm-0">
									<div class="form-item">
										<input type="text" class="date-end" name="hotel_date_end" value="" maxlength="250">
										<i class="fa fa-calendar"></i>
									</div>
								</div>
							</div>
