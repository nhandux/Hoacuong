	...
	$.fn.wtRotator = function(params) {
		...
		function Rotator($obj, opts) {
			...
			var initButtons = function() {
				...
				if (displayPlayBtn) {
					if (!rotate) {
						$playBtn.css("background-image", "url(/js/slide/home/play.png)");
					}
			...
			var playPause = function() {
				rotate = !rotate;
				if (rotate) {
					$(this).css("background-image", "url(/js/slide/home/pause.png)");
					startTimer();
				}
				else {
					$(this).css("background-image", "url(/js/slide/home/play.png)");			
					stopTimer();
				}
				return false;
			}
