...
<div class="row">
	<ol class="breadcrumb">
		...
		<li>
			<i class="fa fa-shopping-cart"></i> Đăng ký học
		</li>
	</ol>
</div>
<!-- /.row -->
				...
				<form action="?<?=TTH_PATH?>=order_list" method="post" enctype="multipart/form-data" id="delete">
					...
					<div class="row">
						...
						<div class="col-sm-6" align="right" style="padding: 7px 0;">
							<input type="button" class="btn btn-primary btn-xs" value="Xuất tất cả dữ liệu ra file Excel" name="exXls" onclick="Forward('register_excel.php');" >
